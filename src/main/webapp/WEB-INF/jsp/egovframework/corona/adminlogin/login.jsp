        	...
        	window.Kakao.Auth.login({
        		...
        		success: function(authObj){
        			...
        			window.Kakao.API.request({
        				url:'/v2/user/me',
        				success: res =>  {
        					window.location.href="kakaoLogin.do?account="+ res.kakao_account.email;        	
        					console.log(); 
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">관리자 로그인</h5>
            <form name="form1" class="form-signin" method="post" action="/loginCheck.do">
