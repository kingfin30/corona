            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid">
                        <h1 class="mt-4"><i class="fas fa-edit"></i> 관리자 패스워드 수정</h1>
                     ...
                     <form name="pwUpdateForm" role="form" method="post" action="adminPwUpdate.do"> 
		<div class="card mb-4">
		    ...
		    <div class="card-header">
					...
					<input type="hidden" id="ano" name="ano" value="${adminPwUpdateView.ano}" readonly/>
                            	...
                            	<tr>
                            		...
                            		<td td colspan='2'>${adminPwUpdateView.adminId} <c:if test="${adminPwUpdateView.right eq '최고관리자'}"><span style="color:red">*</span></c:if> </td>
                            	</tr>
        
			
			
			<tr> 
	   			  <td style="background-color:#F2F2F2"><label for="newPassword"><B>신규 패스워드</B></td>
	    		  <td colspan='2'>
			...
			<tr>
	   			  <td style="background-color:#F2F2F2"><label for="adminPassword"><B>신규 패스워드 확인</B></td>
	    		  <td colspan='2'>
