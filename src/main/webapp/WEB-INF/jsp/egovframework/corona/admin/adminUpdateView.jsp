...
<html lang="en" id="top">
    <head>
		...
		$(document).ready(function(){
			...
			$("#list_btn").on("click", function(){
				...
				location.href = "adminRead.do?ano=${adminUpdate.ano}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"
 ...
 <jsp:include page="nav.jsp"/>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                          <h1 class="mt-4"><i class="fas fa-edit"></i> 관리자 수정</h1>
		    ...
		    <div class="card-header">
                            ...
                            <div class="card-body">
                            <form name="updateForm" role="form" method="post" action="adminUpdate.do">
				...
				<tr><!-- 첫번째 줄 시작 -->
	   			  <td style="background-color:#F2F2F2"><label for="adminId"><B>아이디</B></td>
	    		  <td colspan='2'>
			...
			<tr><!-- 첫번째 줄 시작 -->
	   			  <td style="background-color:#F2F2F2"><label for="adminName"><B>이름</B></td>
	    		  <td colspan='2'>
				...
				<tr><!-- 첫번째 줄 시작 -->
	   			  <td style="background-color:#F2F2F2"><label for="amail"><B>메일</B></td>
				...
				<tr><!-- 첫번째 줄 시작 -->
	   			  <td style="background-color:#F2F2F2"><label for="acontact"><B>개인 연락처</B></td>
	   			      <div class = "input-group">
			...
			<div class = "input-group justify-content-center">
					...
					<button class="btn btn-primary" type="button" id="reset_btn" onclick=
										...
										{ location.href = 
										'adminUpdateView.do?ano=${adminUpdate.ano}';}else{return false;} ">수정 취소</button>&nbsp;
