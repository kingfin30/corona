    ...
    <body class="sb-nav-fixed">
         <jsp:include page="/WEB-INF/jsp/egovframework/corona/admin/nav.jsp"/>
		    ...
		    <div  class="card-header" >
                            ...
                            <div class="card-body">
                            	<form name="xxx" id="xxx" class="form" action="<c:url value='/letterSend2.do'/>" method="post">
        ...
        <label>
            ...
            <input width = "200px" type="text" class="form-control py-4" style="background-color:#E0F8E0" name="receiver" id="receiver" value="<c:out value="${vo.adminId}"/>;"  readonly required>
