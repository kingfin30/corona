 ...
 color:purple;
  ...
  outline:none;
       		...
       		function winOpen(ele){
       			...
       			opener.alert(ele.name+"님에게 쪽지를 보냈습니다.");
       			self.close();
       			return false;
...
<body>
 <div class="card mb-4">
		...
		<div class="input-group">
								...
								<input type="hidden" value="<c:out value="${vo.adminId}"/>" name="receiver" id="receiver"></input>
								
   							  <span>
   							  <c:out value="${vo.adminId}"/>
   							  </span>
    ...
    class="form-control py-4"   name="content" id="content"  rows="15" cols="40"   required></textarea>
			</td>
		...
		<button class="linkbtn" onclick="winOpen(this)" value="/letterSend2" name="<c:out value="${vo.adminId}"/>" style="float:right">보내기</button>
