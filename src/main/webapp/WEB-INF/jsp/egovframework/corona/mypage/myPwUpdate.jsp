...
<html lang="en" id="top">
    ...
    <script>var pwmsg = '${pwmsg}';
       	 ...
       	 <script >
     	function pwCheck(){
      		if(document.pwUpdateForm.password0.value ==""){
      			alert("기존 패스워드를 입력해주세요.");
      			document.pwUpdateForm.password0.focus();
      			return false;
      		}
      		if(document.pwUpdateForm.newPassword.value ==""){
      			alert("신규 패스워드를 입력해주세요.");
      			document.pwUpdateForm.newPassword.focus();
      			return false;
      		}
      		if(document.pwUpdateForm.adminPassword.value ==""){
      			alert("신규 패스워드를 확인해주세요.");
      			document.pwUpdateForm.adminPassword.focus();
      			return false;
      		}
      	
      		if(document.pwUpdateForm.adminPassword.value != document.pwUpdateForm.newPassword.value){
      			alert("신규 패스워드가 일치하지 않습니다.");
      			document.pwUpdateForm.newPassword.focus();
      			return false;
      		}
      		if(document.pwUpdateForm.password0.value == document.pwUpdateForm.newPassword.value){
      			alert("기존 패스워드와 동일합니다.");
      			document.pwUpdateForm.newPassword.focus();
      			return false;
      		}
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid">
                             <h1 class="mt-4"><i class="fas fa-edit"></i> 내 패스워드 수정</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item "><a href="/admin.do"> 대시보드</a></li>
                             <li class="breadcrumb-item "><a href="/adminMyPage.do"> 마이페이지</a></li>
                             <li class="breadcrumb-item active">내 패스워드 수정</li>
                        </ol>
                     <form name="pwUpdateForm" role="form" method="post" action="myPwUpdate.do"> 
		<div class="card mb-4">
		    ...
		    <div class="card-header">
					...
					<input type="hidden" id="ano" name="ano" value="${adminPwUpdateView.ano}" readonly/>
                            	...
                            	<tr> 
	   			  <td><label for="password"><B>기존 패스워드</B></td>
	    		  <td colspan='2'>
			...
			<tr>
			  ...
			  <div class = "input-group justify-content-center">
					...
					<button class="btn btn-primary" type="button" id="list_btn" onclick=
						"location.href = 'adminMyPage.do'">뒤로가기</button>	
					<br/>
				</div>
